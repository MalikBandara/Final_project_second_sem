package org.example.secondsemlastp.config.paypal;
...
public class PaypalService {
    ...
    public Payment createPayment(Double total, String currency, String method, String intent, String description, String cancelUrl, String successUrl) throws PayPalRESTException {
        ...
        // Debugging: Print the links to console
        System.out.println("Generated Payment ID: " + createdPayment.getId());
        for (Links links : createdPayment.getLinks()) {
            System.out.println("Link: " + links.getRel() + " -> " + links.getHref());
        }
