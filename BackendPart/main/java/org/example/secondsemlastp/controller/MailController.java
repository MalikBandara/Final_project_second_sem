...
public class MailController {
    ...
    @PostMapping("sendSeeker/{Email}")
    public ResponseUtil sendEmailToSeeker(@PathVariable String Email) {
        try {
            SimpleMailMessage simpleMailMessage = new SimpleMailMessage();
            simpleMailMessage.setSubject("Seeker Registration Confirmation");
            simpleMailMessage.setTo(Email);
            simpleMailMessage.setFrom("mmalith520@gmail.com");
            simpleMailMessage.setText(
                    "Dear Seeker,\n\n" +
                            "Thank you for registering as a blood Seeker! Your willingness to donate can save lives and make a meaningful impact.\n\n" +
                            "We appreciate your generosity and will contact you when a matching recipient needs your help.\n\n" +
                            "If you have any questions, feel free to reach out to us.\n\n" +
                            "Best Regards,\n" +
                            "Blood Management System - Blood Link Team"
    ...
    @PostMapping("updateSeeker/{Email}")
    public ResponseUtil UpdateStatusSeeker(@PathVariable String Email) {
        try {
            SimpleMailMessage simpleMailMessage = new SimpleMailMessage();
            simpleMailMessage.setSubject("Your Blood  Request Has Been Approved!");
            simpleMailMessage.setTo(Email);
            simpleMailMessage.setFrom("mmalith520@gmail.com");
            simpleMailMessage.setText(
                    "Dear Seeker,\n\n" +
    ...
    @PostMapping("rejectSeeker/{email}")
    public ResponseUtil rejectSeekerMail(@PathVariable String email){
        try {
            SimpleMailMessage simpleMailMessage = new SimpleMailMessage();
            simpleMailMessage.setSubject("Your Blood  Request Has Been Rejected");
            simpleMailMessage.setTo(email);
        simpleMailMessage.setFrom("mmalith520@gmail.com");
            simpleMailMessage.setText(
                    "Dear Seeker,\n\n" +
